...
class RotaryPositionalEmbedding(nn.Module):
    ...
    def forward(self, x: torch.Tensor, token_positions: torch.Tensor) -> torch.Tensor:
        ...
        # print("cos_tri: ", cos_tri)
        # print("sin_tri: ", sin_tri)

        ## save for testing
        # print(f"saving to: {os.path.abspath('rope.npz')}")
        # np.savez(
        #     "rope.npz",
        #     cos_tri=cos_tri.detach().numpy(),
        #     sin_tri=sin_tri.detach().numpy(),
        # )
...
class MyTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        print("x after attn: ", x)

        in_features += x

        print("x after attn and residual: ", in_features)
        ...
        print("x after ffn and residual: ", in_features)
